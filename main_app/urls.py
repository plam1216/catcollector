...
urlpatterns = [ #we will define all app-level urls in this list
    # root path '' is  mapped to views.home function
    # name='home' is an optional kwarg but is used to reference the URL in other parts of the app
    ...
    # sign up path; not provided by Django auth
